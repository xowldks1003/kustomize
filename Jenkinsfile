pipeline {
  ...
  environment {
    ...
    awsecrRegistry = '891377136693.dkr.ecr.ap-northeast-2.amazonaws.com/eks-demo-repo'
    awsecrRegistryCredential = 'credential-AWS-ECR'
    githubCredential = 'credential-github'
    gitEmail = 'xowldks1003@gmail.com'
    gitName = 'xowldks1003'
  }
  ...
  stages {
    ...
    stage('Checkout Application Git Branch') {
      steps {
        checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: githubCredential, url: 'https://github.com/xowldks1003/kustomize.git']]])
      }
      // steps 가 끝날 경우 실행한다.
